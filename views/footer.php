...
<head>
    ...
    <title>Footer</title>
    <link rel="stylesheet" href="views\styles\css\footer.css">
</head>
<body>
    <footer>
        <section>
            <div class="footer-left">
                <div class="footer-logo">
                    <img src="views\styles\imatges\Logo claro.png" alt="">
                    <p>La sportiva menjars</p>
                    <p>08750 Molins de Rei</p>
                </div>
                <div class="footer-xarxes-socials">
                    <a href="#">
