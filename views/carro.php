        ...
        <section class="carro-dades">
            <div class="carro-productes">
                <div class="carro-producte">
                    <div class="carro-producte-foto"></div>
                    <div class="carro-producte-info">
                        <div>
                            <h2>NOM PRODUCTE</h2>
                            <span>
                                <p id="tipus-producte-carro">Tipus: <span id="span-tipusProducte-bold">Tipus producte</span></p>
                                <p>Quantitat: 1</p>
                                <p id="preu-producte-carro">10.00 €</p>
                            </span>
                        </div>
            ...
            <div class="carro-resum-comanda">
                <strong id="resum-comanda-titol">Resumen del pedido</strong>
